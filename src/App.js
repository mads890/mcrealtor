    ...
    return(
      <div className='app'>
        ...
        <footer className='app-footer'>
          <img className='footer-img' src={require('./images/footer-img.png').default} alt='MLS Realtor Logo' />
          <address className='footer-address'>
            <div>Century 21 Bell Real Estate</div>
            <div>2103 Warren Avenue, Cheyenne, Wyoming 82001</div>
            <div>307-635-0336</div>
          </address>
        </footer>
      </div>
    )
